...
# [Project 1: AI Capture the Flag](https://github.com/caelyasutake/CaptureTheFlag)
* Designed, developed, and implemented an AI game agent using reinforcement learning techniques to master the complex, dynamic environment of Capture the Flag in Unity.
